...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal7:drupal7@localhost/drupal7?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://drupal7:drupal7@localhost/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/usr/share/nginx/html/drupal/modules/civicrm';
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://ec2-34-200-52-199.compute-1.amazonaws.com/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'ee62e669270c9c1e4b3ed382d256cb45');
}
